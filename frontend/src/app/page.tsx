  ...
  const features = [
    {
      ...
      description:
        "Create, organize, and manage your tasks with an intuitive interface.",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      title: "Collaborate",
      description:
        "Share tasks and collaborate with team members in real-time.",
    },
    {
      icon: Clock,
      title: "Time Tracking",
    ...
    },
    {
      ...
      title: "Analytics",
      description:
        "Get insights into your productivity with detailed analytics and reports.",
    },
  ];
      ...
      <section className="flex-1 bg-gradient-to-br from-blue-50 via-white to-blue-50 px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed">
            ...
            your tasks effortlessly. Stay focused, accomplish more, and achieve
            your goals with our powerful and intuitive task management platform.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                TaskMaster is built on modern technology with security and
                usability as top priorities. Our platform is designed to help
                individuals and teams manage their work more effectively.
              </p>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 sm:py-32 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg mb-8 text-blue-100 max-w-2xl mx-auto">
            Join thousands of users who are already using TaskMaster to organize
